...
type WorkerServiceClient interface {
	Register(ctx context.Context, in *WorkerInfo, opts ...grpc.CallOption) (*RegisterAck, error)
...
func (c *workerServiceClient) Register(ctx context.Context, in *WorkerInfo, opts ...grpc.CallOption) (*RegisterAck, error) {
...
func (c *workerServiceClient) Ping(ctx context.Context, in *PingRequest, opts ...grpc.CallOption) (*PongResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type WorkerServiceServer interface {
	Register(context.Context, *WorkerInfo) (*RegisterAck, error)
...
func (UnimplementedWorkerServiceServer) Register(context.Context, *WorkerInfo) (*RegisterAck, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Register not implemented")
}
func (UnimplementedWorkerServiceServer) Ping(context.Context, *PingRequest) (*PongResponse, error) {
...
func _WorkerService_Register_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WorkerServiceServer).Register(ctx, req.(*WorkerInfo))
	}
